...
/* Proiectia izometrica */
void Transform3D::isometricProjection()
{
	float IsometricMatrix[4][4];
	//ux = +- 35.264 grade
	//uy = +- 45 grade

	IsometricMatrix[0][0] = 0.7071;	IsometricMatrix[1][0] = 0.408244;	IsometricMatrix[2][0] = 0;	IsometricMatrix[3][0] = 0;
	IsometricMatrix[0][1] = 0;	IsometricMatrix[1][1] = 0.816;	IsometricMatrix[2][1] = 0;	IsometricMatrix[3][1] = 0;
	IsometricMatrix[0][2] = 0.7071;	IsometricMatrix[1][2] = -0.408244;	IsometricMatrix[2][2] = 0;	IsometricMatrix[3][2] = 0;
	IsometricMatrix[0][3] = 0;	IsometricMatrix[1][3] = 0;	IsometricMatrix[2][3] = 0;	IsometricMatrix[3][3] = 1;
	
	multiplyModelMatrix(IsometricMatrix);
